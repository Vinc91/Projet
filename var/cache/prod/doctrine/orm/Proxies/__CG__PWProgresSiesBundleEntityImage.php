 ...
 */
class Image extends \PW\ProgresSiesBundle\Entity\Image implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PW\\ProgresSiesBundle\\Entity\\Image' . "\0" . 'id', '' . "\0" . 'PW\\ProgresSiesBundle\\Entity\\Image' . "\0" . 'url', '' . "\0" . 'PW\\ProgresSiesBundle\\Entity\\Image' . "\0" . 'alt', '' . "\0" . 'PW\\ProgresSiesBundle\\Entity\\Image' . "\0" . 'fichier'];
        }
     ...
     * {@inheritDoc}
     */
    public function setFichier(\Symfony\Component\HttpFoundation\File\UploadedFile $fichier = NULL)
    {
