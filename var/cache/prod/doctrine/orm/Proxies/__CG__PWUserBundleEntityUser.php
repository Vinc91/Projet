...
namespace Proxies\__CG__\PW\UserBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \PW\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'PW\\UserBundle\\Entity\\User' . "\0" . 'series', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt'];
        }
    ...
    public function addSerie(\PW\ProgresSiesBundle\Entity\Serie $serie)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addSerie', [$serie]);

        return parent::addSerie($serie);
    }
    ...
    public function removeSerie(\PW\ProgresSiesBundle\Entity\Serie $serie)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeSerie', [$serie]);

        return parent::removeSerie($serie);
    }
